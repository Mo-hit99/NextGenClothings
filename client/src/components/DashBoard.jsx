...
export default function DashBoard() {
  ...
  async function deleteProduct(id) {
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_SERVER_PRODUCT_LINK}/products/productData/${id}`
      );
  ...
  async function getByIdData(id) {
    try {
      const productDataId = await axios.get(
        import.meta.env.VITE_SERVER_PRODUCT_LINK + `/products/productData/${id}`
      );
          ...
          {productData &&
            productData?.map((item) => (
              <div key={item._id} className="admin-product-card">
                ...
                <div className="admin-product-rate">
                  ⭐{item.rate} <span className="admin-product-count"></span>(
                  {item.count})
                </div>
                ...
                <div className="admin-product-category">
                  {" "}
                  {item.category}
                  <div className="admin-product-author">
                    ...
                    <form id="form-data" encType="multipart/form-data">
                      ...
                      <div className="btn-container">
                        ...
                        <button
                          ...
                          onClick={() => updateSubmitProduct(item._id)}
                        >
                          Update
                        </button>
                      </div>
