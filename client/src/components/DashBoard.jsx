...
export default function DashBoard() {
  ...
  async function fetchProductData(){
    try {
      const response = await axios.get(`${import.meta.env.VITE_SERVER_PRODUCT_LINK}/products/productData`)
...
async function deleteProduct(id){
  try {
    const response = await axios.delete(`${import.meta.env.VITE_SERVER_PRODUCT_LINK}/products/productData/${id}`)
...
async function getByIdData(id){
  try {
    const productDataId =await axios.get(import.meta.env.VITE_SERVER_PRODUCT_LINK + `/products/productData/${id}`);
...
async function updateSubmitProduct(id) {
  try {
    const updateProduct =await axios.put(import.meta.env.VITE_SERVER_PRODUCT_LINK + `/products/productData/${id}`,formData,{
      headers: {
