...
import { truncateString } from "../assets/stringTruncate";
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (response && response.data) {
          ...
          console.log("No users data returned from server.");
        }
      } catch (error) {
        console.error(error);
      }
        ...
        <span className="close-navLink" onClick={()=> setIsMenuOpen(!isMenuOpen)}>&times;</span>
          <div className="nav-link01">
            <ul>
              ...
              UserEmail === import.meta.env.VITE_AdminEmail ? (
                <>
                  <li>
                      ...
                      <div className="dropdown-content">
                        <div className="dropdown-wrapper-for-category">
                          ...
                          {button &&
                            button?.map((ele) => (
                              <div
                                className="btn-category-wrapper"
                                key={ele.id}
                              >
                                <button
