...
export default function RestPassword() {
  ...
  async function submitForm(e) {
    ...
    axios
      .post(
        `${
          import.meta.env.VITE_SERVER_USER_LINK
  ...
  return (
    <>
      ...
      <div className="error3">{error.message}</div>
      <div className="error3">{error.message1}</div>
      <div className="error3">{error.message2}</div>
      <div className="error3">{error.message3}</div>
      </div>
      }
